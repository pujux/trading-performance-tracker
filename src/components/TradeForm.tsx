    ...
    <div className="mb-8">
      ...
      {(isOpen || editingTrade) && (
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 p-6 mt-8 bg-white rounded-lg shadow-lg">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-slate-900">{editingTrade ? "Edit Trade" : "Add New Trade"}</h2>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-6">
            ...
            <div className="md:col-span-3">
              <label className="block text-sm font-medium text-slate-700">End Date & Time {!endDateRequired && "(Optional)"}</label>
              <div className="flex gap-2">
                <input
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-medium text-slate-900">Transactions</h3>
              <button
                type="button"
            ...
            {formData.transactions.map((transaction, index) => (
              <div key={index} className="relative grid grid-cols-1 gap-4 p-8 border-2 rounded-lg md:p-4 md:pt-6 md:grid-cols-4">
                ...
                <div className="relative">
                  <label className="block text-sm font-medium text-slate-700">Order Cost</label>
                  <input
                    required
                    type="number"
                    min="0"
